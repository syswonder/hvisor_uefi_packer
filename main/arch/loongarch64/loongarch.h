...
#define CSR_GTLBC_TGID_SHIFT_END                                               \
  (CSR_GTLBC_TGID_SHIFT + CSR_GTLBC_TGID_WIDTH - 1)
...
#define LOONGARCH_CSR_PGDL                                                     \
  0x19 /* Page table base address when VA[VALEN-1] = 0 */

#define LOONGARCH_CSR_PGDH                                                     \
  0x1a /* Page table base address when VA[VALEN-1] = 1 */
...
#define KVM_ARCH_HANDLE_EXIT                                                   \
  16                        /* offsetof(struct kvm_vcpu_arch, handle_exit) */
